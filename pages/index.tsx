...
export const getStaticProps: GetStaticProps<HomeProps> = async () => {
    const data = await import(
        '../public/data/landing-winter-destinations.json'
    );
    console.log(data);
    return {
        props: {
        ...
        <div className="min-h-screen">
            ...
            <div className="container w-full py-8 px-4 bg-white mx-auto">
                <Card
                    ...
                    style={{
                        backgroundImage:
                            'url("https://static.vecteezy.com/system/resources/previews/008/975/566/non_2x/white-snowflakes-on-blue-background-seamless-pattern-falling-snowflakes-on-blue-backdrop-concept-of-winter-holiday-vector.jpg")',
                ...
                >
                    ...
                    <SuggestedDestinationsCardsComponent
